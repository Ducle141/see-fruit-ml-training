...
//    private let visionQueue = DispatchQueue(label: "com.example.apple-samplecode.FlowerShop.serialVisionQueue")
    private let visionQueue = DispatchQueue(label: "FruitsClassifier")
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "FruitClassifierNew", withExtension: "mlmodelc") else {
